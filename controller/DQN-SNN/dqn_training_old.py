...
# env = VrepEnvironment(sess1, motor_speed, turn_speed, resolution, reset_distance, pub_rate, dvs_queue, resize_factor, crop)
...
with tf.Session() as sess:
    ...
    saver_1.save(sess, path + '/model-'+str(i)+'.cptk')
