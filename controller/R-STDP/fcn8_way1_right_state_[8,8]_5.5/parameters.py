...
max_poisson_freq = 225.				# Maximum Poisson firing frequency for n_max  # 300.  #FCN_8shape: 225.  # FCN_right: 225(before training 300)
max_spikes = 5.5	 				# number of events during each step for maximum poisson frequency
...
# Other
reset_distance = 0.15				# Reset distance   # 0.25   FCN_right:0.15
rate = 20.							# ROS publication rate motor speed
training_length = 17000			# Lenth of training procedure (1 step ~ 50 ms)   #100000  #fcn:18000
max_step = 2500                 # Termination  # 10000  #fcn:1000/1300; FCN_8shape:2000; FCN_right: 2500/4500
