...
# e_o = np.array([6.12, 1.27, 4.75, 7.69, 7.46, 7.60, 7.52, 8.44, 24.23, 31.99, 31.99, 31.99, 31.99])
#
# e_i_o = np.array([282, 467, 775, 1337, 1868, 2391, 2905, 3443, 4626, 6133, 8733, 11133, 13933, ])
#
# e_i = np.array([10.04, 2.19, 5.73, 5.48, 5.71, 5.94, 6.23, 6.08, 6.33, 28.85, 28.85, 28.85, 28.85])
#
# e_i_i = np.array([407, 555, 1012, 1561, 2092, 2618, 3135, 3661, 4833, 7433, 10033, 12633, 15233])
#
# h5f = h5py.File(path + '/rstdp_data_new.h5', 'w')
...
plt.savefig('training_weights_way1.svg', format='svg', dpi=600)
plt.pause(15)
plt.show()
