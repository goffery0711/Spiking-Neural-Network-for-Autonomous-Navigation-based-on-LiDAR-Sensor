...
x1 = env.d1_outer_eightshape
x2 = x1 + env.d2_outer_eightshape
x3 = x2 + env.d3_outer_eightshape
x4 = x3 + env.d4_outer_eightshape
x5 = x4 + env.d5_outer_eightshape
x6 = x5 + env.d6_outer_eightshape
...
plt.savefig('performancegraph_distance_8shape.svg', format='svg', dpi=600)
plt.show()
