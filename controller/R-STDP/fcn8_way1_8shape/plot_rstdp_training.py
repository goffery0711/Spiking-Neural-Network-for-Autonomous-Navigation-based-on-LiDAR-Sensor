...
env = VrepEnvironment()
yo1 = env.d1_outer_eightshape
yo2 = yo1 + env.d2_outer_eightshape
yo3 = yo2 + env.d3_outer_eightshape
yo4 = yo3 + env.d4_outer_eightshape
yo5 = yo4 + env.d5_outer_eightshape
yo6 = yo5 + env.d6_outer_eightshape
yi1 = env.d1_outer_eightshape
yi2 = yi1 + env.d2_outer_eightshape
yi3 = yi2 + env.d3_outer_eightshape
yi4 = yi3 + env.d4_outer_eightshape
yi5 = yi4 + env.d5_outer_eightshape
yi6 = yi5 + env.d6_outer_eightshape
...
ax1.set_ylim((0,yo6))
ax1.set_xticklabels([])
ax1.text(1000, 22.5, 'Outer Lane', color='0.4')
...
ax2.set_ylim((0,yi6))
ax2.set_xticklabels([])
ax2.text(1000, 22.5, 'Inner Lane', color='0.4')
...
plt.savefig('training_weights_8shape.svg', format='svg', dpi=600)
plt.show()
