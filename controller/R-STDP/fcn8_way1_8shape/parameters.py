...
resolution = [8, 8]					# Resolution of reduced image
                                    # newstate = [4,4]; newstate_new = [4,8]; fcn = [8,8]; fcn_right = [8,8]
...
max_poisson_freq = 225.				# Maximum Poisson firing frequency for n_max  # 300.  #FCN_8shape: 225.
max_spikes = 5.3	 				# number of events during each step for maximum poisson frequency
                                    # newstate = 130.; # newstate_new = [20., 22.]; # newstate_fcn = 5.3; # newstate_diff (X:160,200,250,130,90); newstate_fcn_right = 5.5
# R-STDP parameters
...
reward_factor = 0.01				# Reward factor modulating reward signal strength  #0.01
...
training_length = 17000			# Lenth of training procedure (1 step ~ 50 ms)   #100000  #fcn:18000
max_step = 2000                 # Termination  # 10000  #fcn:1000/1300; FCN_8shape:2000; FCN_right: 2500/controller-4500
