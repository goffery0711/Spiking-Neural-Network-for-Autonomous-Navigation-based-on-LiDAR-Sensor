...
ax3.set_xlim((0,xlim))
ax3.set_ylim((0,4000))   # 2300   # 4000
ax3.set_xticklabels([])
ax3.text(1000, 3500, 'Left Motor', color='0.4')
...
ax4.set_xlim((0,xlim))
ax4.set_ylim((0,4000))   # 2300   # 4000
ax4.text(1000, 3500, 'Right Motor', color='0.4')
...
plt.savefig('training_weights_height.svg', format='svg', dpi=600)
plt.pause(15)
plt.show()
